...
#define HUWWEIYUN_MQTT_IP "988f555dbf.st1.iotda-device.cn-north-4.myhuaweicloud.com"
// MQTT客户端ID
#define MQTT_CLIENT_ID "660128f92ccc1a58387e33ce_hi38614gtest_0_0_2024032507"  
// MQTT用户名
#define MQTT_USER_NAME "660128f92ccc1a58387e33ce_hi38614gtest"      
// MQTT密码
#define MQTT_PASS_WORD "6c3fc3d0381bd0295ff56759ae3876f7820d479019537433dfc9c056bff64c68"
...
typedef enum
{
    ...
    AT_CREG,       //查询网络的注册状态
    AT_CGATT,      //查询网络附着状态
    AT_QMTOPEN,    //打开MQTT客户端网络
    AT_QMTCONN,    //连接客户端到MQTT服务器
    AT_QMTPUB,     //发布主题消息
    AT_QMTDISC,    //断开MQTT服务器连接
} teATCmdNum;
//AT指令结构体
typedef struct
{
